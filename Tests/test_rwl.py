...
def test_find_item__isbn10__makes_good_request():
    ...
    assert opener.last_request['url'] == 'http://www.regionofwaterloo.canlib.ca/uhtbin/cgisirsi/uOtJAQjVct/HEADQUARTR/x/5/0/?searchdata1=0060515198'
...
def test_find_item__isbn10_in_library__returns_record():
    ...
    assert record == 'http://www.regionofwaterloo.canlib.ca/uhtbin/cgisirsi/uOtJAQjVct/HEADQUARTR/x/5/0/?searchdata1=0060515198'
